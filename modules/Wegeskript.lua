...
if PLAYER and PLAYER.core then
...
local function path_is_usable(edge)
  ...
  if allowed then
    if type(allowed) == "table" then
      if not table.contains(allowed, PLAYER.world()) then
        return false
      end
    else
      if allowed ~= PLAYER.world() then
        return false
      end
    end
  end
  ...
  if forbidden then
    if type(forbidden) == "table" then
      if table.contains(forbidden, PLAYER.world()) then
        return false
      end
    else
      if forbidden == PLAYER.world() then
        return false
      end
    end
  end
